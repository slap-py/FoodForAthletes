...
Food For Athletes is an iPhone-only SwiftUI meal and water logger designed around athletes' real eating rhythms. Users describe a meal in a sentence and attach a photo; the app identifies approximate foods, portions, and macros, then presents a compact editable review before saving.
...
- Approximate food and macro interpretation from text and photos
- Canonical food matching with USDA FoodData Central data
